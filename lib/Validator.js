...
Validator.prototype.validateStreamFile = function (ttlFile, ontologyFilter = null, extraFiles = [], cb) {
  const self = this;
...
Validator.prototype.validateStreamFileByOntologies = function (ttlFile, ontologies, extraFiles = [], cb) {
  const self = this;
